        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-stretch gap-2 md:gap-8" style={{ minHeight: 'inherit' }}>
            ...
            <div className="flex flex-col justify-center order-1 md:order-1 md:pl-2 text-left mt-0 px-4 sm:px-0">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 border border-gray-200 rounded-full px-3 py-1 text-gray-800 w-fit mx-0" style={{ backgroundColor: 'rgba(242, 242, 252, 0.7)' }}>
                <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                </svg>
                <span className="hero-badge-text">Convenient, online care covered by insurance</span>
              </div>
