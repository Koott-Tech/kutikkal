      ...
      <div className="mx-auto max-w-[1400px] px-0 md:px-2">
        <section className="text-black rounded-none md:rounded-[10px] p-0 sm:p-8 md:p-[50px] mx-0 md:mx-0" style={{ background: 'linear-gradient(98.54deg, rgba(153, 126, 255, .25) 6.76%, rgba(153, 126, 255, .2) 98%)', minHeight: '88vh', height: '88vh' }}>
          <div className="grid h-full grid-cols-1 gap-6 md:gap-8 md:grid-cols-2">
            {/* Left: Text */}
            <div className="flex flex-col justify-center order-1 md:order-1 md:pl-2 text-center md:text-left mt-8 md:mt-0 px-4 sm:px-0">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 border border-gray-200 rounded-full px-3 py-1 text-sm font-medium text-gray-800 w-fit mx-auto md:mx-0" style={{ backgroundColor: 'rgba(242, 242, 252, 0.7)' }}>
            ...
            <div className="relative flex items-center justify-center order-2 md:order-2 min-h-[300px] md:min-h-0">
              <Image
                ...
                alt="Hero"
                fill
                className="object-contain object-bottom scale-125 md:scale-150 translate-y-6 md:translate-y-10"
