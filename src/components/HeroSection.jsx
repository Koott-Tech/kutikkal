      ...
      <section className="w-full">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 items-start">
             ...
             <div className="p-8 md:p-12 pb-20 md:pb-24 pt-16 md:pt-20 mt-21 space-y-6">
                               <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-[#323232] leading-none">
                  Take the first step,<br />
                  individual therapy<br />
                  through Rula.
                </h1>
                
                <p className="text-lg md:text-xl text-black leading-relaxed font-normal leading-tight">
                  Rula makes it simple to take the first step towards better mental<br />
                  health. Explore licensed, in-network therapists online who<br />
