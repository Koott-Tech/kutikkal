...
export const metadata = {
  ...
  description: "Professional support for children with ADHD and attention difficulties. Evidence-based interventions to help improve focus and attention skills.",
};

export default function AdhdAttentionPage() {
  return (
    <div>
      <HeroSection therapyType="adhd-attention" />
